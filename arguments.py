...
from app import DEFAULT_VERBOSITY, DEFAULT_MIN_ROUNDS, \
    DEFAULT_AVERAGE_ROUNDS, DEFAULT_END_EARLY, DEFAULT_PLAYERS, DEFAULT_QUIET
from bots import *
...
def get_arguments():
    ...
    game_options.add_argument("-v", "--verbose", dest="verbose",
                        default=DEFAULT_VERBOSITY, action="store_true",
                        help="use verbose output (off by default)")
    game_options.add_argument("-q", "--quiet", dest="quiet",
                        default=DEFAULT_QUIET, action="store_true",
                        help="use quiet output - no output at all (off by default)")
